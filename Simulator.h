...
public:
	...
	void show_stats()
	{
		...
		// FIXED: Calculate and display the average wait time for the landing queue
		std::cout << "Average wait time in the arrival queue: " << landing_queue->get_total_wait() / landing_queue->get_num_served() << std::endl;
		...
		// FIXED: Calculate and display the average wait time for the departure queue
		std::cout << "Average wait time in the departure queue: " << departure_queue->get_total_wait() / departure_queue->get_num_served() << std::endl;
